...
DeviceAddress listSensors[]= {
  {0x28, 0xFF, 0xDE, 0xC3, 0xA4, 0x16, 0x04, 0x4A },
{0x28, 0xFF, 0x4B, 0xB8, 0xA4, 0x16, 0x05, 0x4D },
 {0x28, 0xFF, 0x25, 0xC7, 0xA4, 0x16, 0x04, 0x92},
{0x28, 0xFF, 0xAD, 0x6F, 0xA4, 0x16, 0x05, 0x8C },
{0x28, 0xFF, 0xBF, 0xC0, 0xA4, 0x16, 0x05, 0x40},
{0x28, 0xFF, 0xE0, 0xB5, 0xA4, 0x16, 0x05, 0x93},
{0x28, 0xFF, 0x7D, 0xB5, 0xA4, 0x16, 0x05, 0xC8},
 {0x28, 0xFF, 0x95, 0xB2, 0xA4, 0x16, 0x05, 0xAA },
 {0x28, 0xFF, 0xC9, 0xC6, 0xA4, 0x16, 0x05, 0xB8},
{0x28, 0xFF, 0x1B, 0xB4, 0xA4, 0x16, 0x04, 0x94}
...
RTC.setAlarm(ALM1_MATCH_MINUTES , 0, 0, 0, 0); //Logger will wake up next hour at 0 minutes and 0 seconds
...
void setRTCagain() {
  ...
  if ( RTC.alarm(ALARM_1) )
  {
    ...
    // set the alarm
    DateTime now = rtc.now();    
    DateTime future (now + TimeSpan(0, 0, LogInterval, 0)); //Days, Hours, Minutes, Seconds
