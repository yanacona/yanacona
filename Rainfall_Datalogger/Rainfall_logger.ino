...
void Initialize_SDcard()
{
 ...
 //TURN ON TRANSISTORS
  ...
  delay(10); //Give time for current to flow properly
...
//CHECKING BATTERY VOLTAGE
  ...
  //ADDING HEADERS TO CSV FILE. UNCOMMENT ONLY IF THERE ARE LESS THAN 20 COLUMNS WITH SHORT NAMES
     ...
     File dataFile = SD.open(loggerID, O_CREAT | O_APPEND | O_WRITE);
	 delay(10);
...
void sleepNow() {  
    ...
    attachPinChangeInterrupt(22,wakeUpNow, CHANGE); // use interrupt 22 (pin 6) and run function  
